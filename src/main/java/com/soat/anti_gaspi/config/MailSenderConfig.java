...
public class MailSenderConfig {
    ...
    @Bean
    SendConfirmationMailUseCase sendConfirmationMailUseCase(FindOfferRepository findOfferRepository, LinksService linksService, ThymeLeafEmailGenerator emailGenerator, GmailEmailSender mailSender) {
